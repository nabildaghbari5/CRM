...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  userConnectedString = localStorage.getItem('UserConnected');
  userConnected: UserConnected = JSON.parse(this.userConnectedString);
  userRole: string = this.userConnected.role;
